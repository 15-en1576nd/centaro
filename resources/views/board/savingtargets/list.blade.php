                ...
                <div class="flex items-center">
                    ...
                    <div class="flex flex-col justify-center w-full">
                        <div class="text-lg justify-between flex flex-row">
                            <a class="hover:underline cursor-pointer flex flex-row items-center" href="{{ route('boards.savingtargets.show', ['board' => $board, 'boardsavingtarget' => $savingtarget->id])}}">
                        ...
                        @if($progress == 100)
                            <svg xmlns="http://www.w3.org/2000/svg" class="ml-1 h-6 w-6 rounded-md hover:bg-emerald-600 cursor-pointer" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
